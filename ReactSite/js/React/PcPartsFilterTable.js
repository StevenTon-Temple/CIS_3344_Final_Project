const PcPartsFilterTable = ({list}) => {

    console.log("PcPartsFilterTable running!!");
    ...
    const doFilter = () => {
        ...
        console.log("PcPartsFilterTable Search clicked. See filtered list on next line:");
        console.log(newList);
        setItems(newList);
    };
    ...
    return (
        <div className="clickSort">
            ...
            {isFirstRender ? <PcPartsTable list={list} /> : <PcPartsTable list={items} />}
        </div>
    );
};